...
- **Рекомендация:** Сделайте резервную копию файла `.finance_tracker_data/finance.db` перед обновлением
...
if PROPRIETARY_AVAILABLE:
    ...
    print("Cloud sync недоступен без приватного submodule")
```
...
4. Проверьте основные функции (создание транзакций, кредитов, навигация)
