...
- [x] 4. Обновление config.py для пользовательской директории данных
  - Реализовать метод get_user_data_dir() для создания .finance_tracker_data/ рядом с приложением
