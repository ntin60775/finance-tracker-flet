...
- [ ] 1. Обновить PendingPaymentsWidget с кнопкой добавления
...
- [ ] 1.1 Написать unit тесты для кнопки добавления
...
- [ ] 2. Добавить метод create_pending_payment в HomePresenter
...
- [ ] 2.1 Написать unit тесты для HomePresenter.create_pending_payment
...
- [ ] 3. Обновить HomeView для интеграции модального окна
...
- [ ] 3.1 Написать unit тесты для HomeView
...
- [ ] 4. Реализовать навигацию к разделу отложенных платежей
...
- [ ] 4.1 Написать unit тесты для навигации
...
- [ ] 5. Checkpoint - Убедиться, что все базовые функции работают
...
- [ ] 6. Написать property-based тесты для создания платежей
  - [ ] 6.1 Property test: Создание платежа сохраняет в БД
  ...
  - [ ] 6.2 Property test: Создание платежа обновляет виджет
  ...
  - [ ] 6.3 Property test: Создание платежа обновляет статистику
  ...
  - [ ] 6.4 Property test: Платёж с датой отображается в календаре
  ...
  - [ ] 6.5 Property test: Каскадное обновление компонентов
  ...
  - [ ] 6.6 Property test: Валидация пустых полей
...
- [ ] 7. Написать интеграционный тест полного цикла
...
- [ ] 8. Финальный checkpoint - Убедиться, что все тесты проходят
  ...
  - Проверить покрытие кода: `pytest --cov=src/finance_tracker --cov-report=html`
  - Если есть вопросы - спросить пользователя
