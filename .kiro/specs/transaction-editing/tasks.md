...
- [x] 6. Добавить визуальные индикаторы интерактивности
...
- [x] 7. Написать unit тесты для TransactionsPanel
...
- [x] 8. Написать unit тесты для TransactionModal
...
- [x] 9. Написать unit тесты для HomePresenter
...
- [x] 10. Написать property-based тесты
