...
- [ ] 5. Реализовать тесты для LoansView
  - [ ] 5.1 Создать `tests/test_loans_view.py`
    - Тест инициализации View
...
- [ ] 5.2 Написать property-based тест для статистики кредитов
  - **Property: Статистика должна корректно рассчитываться для любого набора кредитов**
  - **Validates: Requirements 8.5**

- [ ] 6. Реализовать тесты для LoanDetailsView
  - [ ] 6.1 Создать `tests/test_loan_details_view.py`
...
- [ ] 7. Реализовать тесты для PendingPaymentsView
  - [ ] 7.1 Создать `tests/test_pending_payments_view.py`
    - Тест инициализации View
...
- [ ] 7.2 Написать property-based тест для выполнения платежей
  - **Property: Выполнение платежа должно создавать транзакцию и удалять платеж**
  - **Validates: Requirements 10.2**

- [ ] 8. Реализовать тесты для PlannedTransactionsView
  - [ ] 8.1 Создать `tests/test_planned_transactions_view.py`
    - Тест инициализации View
...
- [ ] 9. Реализовать тесты для PlanFactView
  - [ ] 9.1 Создать `tests/test_plan_fact_view.py`
    - Тест инициализации View
...
- [ ] 9.2 Написать property-based тест для расчета отклонений
  - **Property: Отклонения должны корректно рассчитываться для любых план-факт данных**
  - **Validates: Requirements 12.5**

- [ ] 10. Реализовать тесты для SettingsView
  - [ ] 10.1 Создать `tests/test_settings_view.py`
    - Тест инициализации View
...
- [ ] 11. Реализовать тесты для MainWindow
  - [ ] 11.1 Создать `tests/test_main_window.py`
...
- [ ] 11.2 Написать property-based тест для навигации
  - **Property 8: Навигация между View**
  - **Property 9: Закрытие View при навигации**
  - **Validates: Requirements 5.1, 5.2, 5.3**

- [ ] 12. Создать property-based тесты для универсальных свойств View
...
- [ ] 14. Обновить документацию по запуску тестов
  - [ ] 14.1 Добавить в README.md секцию "Запуск тестов"
