...
- [x] 7.1 Написать интеграционные тесты
...
- [x] 8. Обработка ошибок и стабильность
...
- [x] 8.1 Написать тесты обработки ошибок
...
- [x] 9.1 Написать финальные property тесты
